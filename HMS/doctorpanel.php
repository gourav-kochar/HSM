...
<body style="background-color: grey;"> 
  ...
  <a href="viewmypatient.php" class="list-group-item list-group-item-action" >my Appointments
  </a>
  <a href="messages.php" class="list-group-item list-group-item-action">all messagess</a>
